...
use casamunoz\empresaBundle\Form\FosUserUserType;
...
class FosUserUserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('casamunozempresaBundle:FosUserUser')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('casamunozempresaBundle:FosUserUser')->find($id);
