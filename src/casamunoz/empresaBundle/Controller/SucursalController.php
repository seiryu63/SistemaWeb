...
use casamunoz\empresaBundle\Entity\Sucursal;
use casamunoz\empresaBundle\Form\SucursalType;
...
class SucursalController extends Controller
{
     ...
     * @Method("POST")
     * @Template("casamunozempresaBundle:Sucursal:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('casamunozempresaBundle:Sucursal')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("casamunozempresaBundle:Sucursal:edit.html.twig")
     */
