...
use casamunoz\empresaBundle\Entity\Empleado;
use casamunoz\empresaBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('casamunozempresaBundle:Empleado')->findAll();
     ...
     * @Method("POST")
     * @Template("casamunozempresaBundle:Empleado:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('casamunozempresaBundle:Empleado')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("casamunozempresaBundle:Empleado:edit.html.twig")
     */
